package cis_ubuntu_20_04

# CIS Ubuntu 20.04 LTS Benchmark - Complete Compliance Assessment
# Master orchestrator that aggregates all modular validation policies
# Benchmark Version: CIS Ubuntu Linux 20.04 LTS Benchmark v1.1.0

import rego.v1

# Import all validation modules
import data.cis_ubuntu_20_04.filesystem
import data.cis_ubuntu_20_04.initial_setup
import data.cis_ubuntu_20_04.services
import data.cis_ubuntu_20_04.network
import data.cis_ubuntu_20_04.logging
import data.cis_ubuntu_20_04.auditd
import data.cis_ubuntu_20_04.ssh
import data.cis_ubuntu_20_04.pam
import data.cis_ubuntu_20_04.sudo
import data.cis_ubuntu_20_04.apparmor
import data.cis_ubuntu_20_04.user_group
import data.cis_ubuntu_20_04.cron
import data.cis_ubuntu_20_04.boot_security
import data.cis_ubuntu_20_04.file_permissions
...
compliance_assessment := {
	"assessment_metadata": {
		"benchmark": "CIS Ubuntu Linux 20.04 LTS Benchmark v1.1.0",
