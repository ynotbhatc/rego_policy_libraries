package cis_rhel9.initial_setup

import rego.v1

# CIS Sections 1.2, 1.7, 1.8, 1.9: Initial System Setup
# Software updates, warning banners, GNOME configuration, crypto policy
...
# Note: This is environment-specific, only check if GDM is installed but not intentionally used
violations contains msg if {
...
violations contains msg if {
    ...
    msg := sprintf("CIS 1.8.4: GDM idle delay is %d seconds, should be 900 or less",
        [input.initial_setup.gdm_idle_delay])
}
