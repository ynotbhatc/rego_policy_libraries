...
validate_pwquality_complexity if {
	complexity_sum := ((abs(to_number(input.pam.pwquality.dcredit)) + abs(to_number(input.pam.pwquality.ucredit))) + abs(to_number(input.pam.pwquality.lcredit))) + abs(to_number(input.pam.pwquality.ocredit))
	complexity_sum >= 4
}
