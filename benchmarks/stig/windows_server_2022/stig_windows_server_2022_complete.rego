...
# DISA STIG for Windows Server 2022 - Simplified Complete Assessment
...
finding_v_254238_dod_root_ca := {
	...
	"severity": "CAT I",
	"rule_title": "Windows Server 2022 must have the DoD Root CA certificates installed",
...
finding_v_254243_antivirus := {
	...
	"severity": "CAT I",
	"rule_title": "The Windows Server 2022 system must use an antivirus program",
...
stig_assessment := {
	"assessment_metadata": {
		"stig_title": "Windows Server 2022 Security Technical Implementation Guide",
