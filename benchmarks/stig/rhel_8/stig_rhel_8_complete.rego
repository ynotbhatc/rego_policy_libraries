...
# DISA STIG for RHEL 8 - Simplified Complete Assessment
...
finding_v_254238_dod_root_ca := {
	"vuln_id": "V-257238",
	"stig_id": "RHEL-08-PK-000010",
	"severity": "CAT I",
	"rule_title": "RHEL 8 must have the DoD Root CA certificates installed",
...
finding_v_254243_antivirus := {
	"vuln_id": "V-257243",
	"stig_id": "RHEL-08-00-000020",
	"severity": "CAT I",
	"rule_title": "The RHEL 8 system must use an antivirus program",
	"status": antivirus_status,
}

antivirus_status := "Open" if {
	not input.packages.clamav_installed
} else := "Not_a_Finding"
...
stig_assessment := {
	"assessment_metadata": {
		"stig_title": "RHEL 8 Security Technical Implementation Guide",
