...
finding_v_254238_dod_root_ca := {
	...
	"severity": "CAT I",
	"rule_title": "Windows 10 must have the DoD Root CA certificates installed",
...
finding_v_254243_antivirus := {
	...
	"severity": "CAT I",
	"rule_title": "The Windows 10 system must use an antivirus program",
...
stig_assessment := {
	"assessment_metadata": {
		"stig_title": "Windows 10 Security Technical Implementation Guide",
