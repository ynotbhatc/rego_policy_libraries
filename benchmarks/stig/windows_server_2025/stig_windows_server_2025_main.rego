...
package stig.windows_server_2025.main
...
_no_facts_finding := {
	"rule_title": "FAIL-CLOSED: no facts supplied for stig.windows_server_2025 — the assessment could not be evaluated. This is NOT a passing result; check that fact collection ran and produced input.",
	"severity": "CAT I",
	"status": "Open",
}

_upstream := windows_server_2025.compliance_report
