...
_no_facts_finding := {
	"rule_title": "FAIL-CLOSED: no facts supplied for stig.apache_2_4_unix — the assessment could not be evaluated. This is NOT a passing result; check that fact collection ran and produced input.",
	"severity": "CAT I",
	"status": "Open",
}

_upstream := apache_2_4_unix.compliance_report
