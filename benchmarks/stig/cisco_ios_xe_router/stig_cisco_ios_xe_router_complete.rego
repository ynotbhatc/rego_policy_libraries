...
# Coverage: 10 of 42 rules (8 of 8 CAT I).
# Rule IDs verified against the July 2026 SRG-STIG library on 2026-09-03.

import rego.v1

import data.stig.cisco_ios_xe_router.core
...
stig_assessment := {
	"metadata": {
		"stig_title": "Cisco IOS XE Router NDM Security Technical Implementation Guide",
		"version": "V3R7",
		"release": "Release: 7 Benchmark Date: 01 Apr 2026",
		"platform": "Cisco IOS-XE Router (NDM)",
