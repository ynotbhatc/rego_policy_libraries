...
_no_facts_finding := {
	"rule_title": "FAIL-CLOSED: no facts supplied for stig.cisco_ios_xe_router — the assessment could not be evaluated. This is NOT a passing result; check that fact collection ran and produced input.",
	"severity": "CAT I",
	"status": "Open",
}

_upstream := cisco_ios_xe_router.compliance_report
