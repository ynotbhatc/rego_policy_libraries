...
_no_facts_finding := {
	"rule_title": "FAIL-CLOSED: no facts supplied for stig.vmware_vsphere_8 — the assessment could not be evaluated. This is NOT a passing result; check that fact collection ran and produced input.",
	"severity": "CAT I",
	"status": "Open",
}

_upstream := vmware_vsphere_8.compliance_report
