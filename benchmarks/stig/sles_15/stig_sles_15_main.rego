...
_no_facts_finding := {
	"rule_title": "FAIL-CLOSED: no facts supplied for stig.sles_15 — the assessment could not be evaluated. This is NOT a passing result; check that fact collection ran and produced input.",
	"severity": "CAT I",
	"status": "Open",
}

_upstream := sles_15.compliance_report
