...
# DISA STIG for RHEL 9 - Simplified Complete Assessment
...
finding_v_254238_dod_root_ca := {
	"vuln_id": "V-257238",
	"stig_id": "RHEL-09-PK-000010",
	"severity": "CAT I",
	"rule_title": "RHEL 9 must have the DoD Root CA certificates installed",
...
finding_v_254243_antivirus := {
	"vuln_id": "V-257243",
	"stig_id": "RHEL-09-00-000020",
	"severity": "CAT I",
	"rule_title": "The RHEL 9 system must use an antivirus program",
...
stig_assessment := {
	"assessment_metadata": {
		"stig_title": "RHEL 9 Security Technical Implementation Guide",
