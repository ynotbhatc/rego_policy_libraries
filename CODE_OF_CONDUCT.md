...
This is a policy library. Disagreement about how a control should be interpreted
is expected and welcome — standards are ambiguous and reasonable people read
them differently. Argue about the control, cite the source, and assume the other
person has read it too.
...
reported to the maintainers at **ynotbha@aisle-five.com**. All complaints will
